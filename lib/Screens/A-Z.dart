...
class AZClients extends StatefulWidget {
  @override
  _AZClientsState createState() => _AZClientsState();
}

class _AZClientsState extends State<AZClients> {
  // Timestamp formater;
  ...
  getdata() async {
    ...
    await firestore
        ...
        .then((QuerySnapshot snapshot) => snapshot.docs.forEach((e) {
              ...
              nameList.sort((a, b) => a.clientName.compareTo(b.clientName));
